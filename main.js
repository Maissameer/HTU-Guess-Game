...
function getGuess(){
    ...
    const name_container = document.getElementById('local-storage');
    let data = "";
    let countries="";
    let all_Img='';
    let local='';
    ...
    age.then((response)=>{
        ...
        document.getElementById("local-storage").innerHTML = localStorage.getItem("name");
    ...
    fetchPromise
      ...
      .then((result) => {
        ...
        return country.json();
                ...
                <div class="main-img">
                ${genderType.gender == `male`?`<img src="./img/male.png" alt="">`
